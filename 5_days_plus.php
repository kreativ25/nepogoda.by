...
<head>
    ...
    $website_keywords = 'Подробный прогноз погоды '. $gorod_poisk;
    ...
    <div class="row">
        <div class="col-md-9 mb-3">
            ...
            <div class="mt-2">
                ...
                <p>На данной странице представлен почасовой прогноз погоды в населенном пункте <?php echo $gorod_poisk; ?>. </p>
                ...
                <p>Данные почасового прогноза погоды в населенном пункте <?php echo $gorod_poisk; ?> носит исключительно консультативный характер и не могут использоваться в качестве официального источника данных о погоде при планировании мероприятий, связанных с риском материального ущерба.</p>
                <p>Информацию о почасовом прогнозе погоды в населенном пункте <?php echo $gorod_poisk; ?> запрещено использовать в любых коммерческих целях, в частности в любых средствах массовой информации, на телевидении, Интернете, табло, радио, бордах и прочее.</p>
                <h3>О сайте</h3>
