    ...
    <head>
        ...
        $website_title = 'NEPOGODA.BY | Погода '. $gorod_poisk . '. Прогноз погоды '. $gorod_poisk;
        ...
        $website_keywords = 'Почасовой прогноз '. $gorod_poisk;
        ...
        <div class="row">
            <div class="col-md-9 mb-3">
                ...
                <div class="mt-2">
                    ...
                    <p>На данной странице представлен укрупненный прогноз в населенном пункте <?php echo $gorod_poisk; ?>. </p>
                    ...
                    <p>Данные укрупненного прогноза погоды в населенном пункте <?php echo $gorod_poisk; ?> носит исключительно консультативный характер и не могут использоваться в качестве официального источника данных о погоде при планировании мероприятий, связанных с риском материального ущерба.</p>
                    <p>Информацию об укрупненном прогнозе погоды в населенном пункте <?php echo $gorod_poisk; ?> запрещено использовать в любых коммерческих целях, в частности в любых средствах массовой информации, на телевидении, Интернете, табло, радио, бордах и прочее.</p>
                    <h3>О сайте</h3>
